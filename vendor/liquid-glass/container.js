class Container {
  ...
  constructor(options = {}) {
    ...
    this.tintOpacity = options.tintOpacity !== undefined ? options.tintOpacity : 0.45
  ...
  `
    ...
    void main() {
      ...
      vec2 center = vec2(0.5, 0.5);
        ...
        // Simple vertical gradient (Gold-Toenung statt Weiss/Grau, passend zur Marke)
        float gradientPosition = coord.y;
        vec3 topTint = vec3(1.0, 0.93, 0.78);
        vec3 bottomTint = vec3(0.72, 0.55, 0.26);
